        ...
        <nav className='nav'>
            ...
            <div className={open ? 'nav__links_expanded' : 'nav__links'}>
                <ul>
                    ...
                    <Link className='nav__link' onClick={() => setOpen(false)} to="/collections/beanies"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
